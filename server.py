...
:root{{--bg:#f5f4ed;--top:rgba(250,249,245,.94);--panel:#faf9f5;--panel-2:#f1eee4;--card:#faf9f5;--section-bg:#f7f3ea;--text:#141413;--text-2:#5e5d59;--muted:#87867f;--border:#e8e6dc;--border-2:#d1cfc5;--accent:#c96442;--accent-2:#d97757;--link:#8f4b36;--code-bg:#f1eee6;--quote:#efe8de;--soft:#f3f0e8;--header-h:56px;--sidebar-w:300px;--right-w:260px;color-scheme:light}}
