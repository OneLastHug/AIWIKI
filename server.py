...
def repo_card_html(row: sqlite3.Row) -> str:
    ...
    jump = ("<span class='repo-jump' aria-hidden='true'>"
    ...
    return (
        ...
        f"</div>"
        f"<div class='repo-footer'><span class='repo-open'>查看文档</span>{jump}</div>"
        f"</a></li>"
    )
