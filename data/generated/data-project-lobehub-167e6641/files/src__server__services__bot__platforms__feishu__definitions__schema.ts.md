# 文件：src/server/services/bot/platforms/feishu/definitions/schema.ts

## 文件职责
这个文件位于 `src/server/services/bot/platforms/feishu/definitions`。下面根据源码片段、导入导出和命名推断它在项目中的职责。
